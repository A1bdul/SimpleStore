...
if (Number(id)){
    ...
    .then(r => r.json())
    .then(data => {
        $('.brand-logo').attr('src', data.owner.logo)
        ...
        for (let i in data.product.image){
            ...
            $('#big-sliderview').append(`  <div class="swiper-slide">
        ...
        $('#small-sliderview').append(`<div class="product-thumb swiper-slide">
        <img src="${image}"
...
const getUser = ()=>{
    fetch('/api/consumer', {
        ...
        if (data.user) {
            ...
            Wolmart.ProductList();
            Wolmart.RefreshPage();
            renderData(data.wish_list, 'wishlist')
        }
    });
}
getUser()
        ...
        init: function() {
            ...
            Wolmart.$body.on("click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart", (function(e) {
                ...
                var i = $(this)
                  ...
                  , index = SearchCart(`${a.find(".product-media img, .product-image:first-child img").attr("src")}`)
            ...
            function() {
                var e, i = JSON.parse(Wolmart.getCookie('compare')), a = t(".page-wrapper > .compare-popup");
                function q(removed) {
