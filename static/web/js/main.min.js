...
$.extend($.easing, {
        ...
        Wolmart.$window = t(window),
            ...
            Wolmart.ProductList = function () {
                ...
                function renderData(data) {
                    let i = "";
                    $.each(data.product['image'], function (index, image) {
                        ...
                        i += `<div class="product-thumb swiper-slide">
        <img src="${image}"
            alt="${data.product.name} Thumbnail" width="800" height="900">
    </div>`
                    })
                    $(`#${pk}`).find('.product-link-wrapper').append(Icon(data.product.id, 'compare'))
                    $(`#${pk}`).find('.product-icon').html(Icon(data.product.id, 'cart', true))
                    ...
                    document.querySelector('#small-sliderview').innerHTML = i;
                    $('.vendor-products').html(renderProducts(data['vendor_products']))
            ...
            Wolmart.setTab = function (e) {
                ...
                Wolmart.$body.on('click', '.icon-mode-grid, .icon-mode-list', (function (e) {
                        ...
                        if (e.preventDefault(),
                            ...
                            i.prev().removeClass('active'),
                                i.next().removeClass('active'),
                                i.addClass('active');
                            $(`#shop-${v}`).prev('.product-wrapper').hide(),
                                $(`#shop-${v}`).next('.product-wrapper').hide(),
                                $(`#shop-${v}`).show()
                        }
                    }
                ))
    ...
    function (t) {
        ...
        if (!Wolmart.getCookie('compare'))
            Wolmart.setCookie('compare', JSON.stringify([]), 4);
        ...
        var e = {
            init: function () {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                    ...
                    Wolmart.$body.on("click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart", (function (e) {
                            ...
                            var i = $(this)
                                ...
                                , index = SearchCart(`${a.attr('id')}`)
                                ,
                                message = index ? "<p>has been removed from cart </p>" : "<p>has been added to cart:</p>"
                                ,
                                inner = index ? '<i class="w-icon-cart"></i> Add To Cart' : '<i class="w-icon-cart"></i> Selct Options';
                            ...
                            i.hasClass("disabled") ? alert("Please select some product options before adding this product to your cart.") : (t(".page-wrapper .product img").each((function () {
                                    if (this.getAttribute("src") == a.find(".product-media img, .product-image:first-child img").attr("src")) {
                                        ...
                                        if (e.hasClass('w-icon-cart') || e.hasClass('w-icon-minus')) {
                                            ...
                                            e.html(inner),
                                                t(this).closest('.product').toggleClass('product-select'), e.attr('href', (_, attr) => inner == '<i class="w-icon-cart"></i> Add To Cart' ? '#' : 'product')
                                        }
                                    }
                                }
                            )),
                ...
                (e = t(".product-popup")).length && Wolmart.$body.on("click", ".btn-quickview", (function (i) {
                        ...
                        b.addClass("load-more-overlay loading"),
                            console.log(Icon(Number(a.attr('id')), 'compare'))
                        v.attr('id', a.attr('id'))
                        v.find(".product-title").text(a.find('.product-name, product-title').text()),
                            v.find('.product-link-wrapper').html(Icon(Number(a.attr('id')), 'compare'));
                        i.preventDefault(),
                            fetch(`/api/product/${a.attr('id')}`).then(res => res.json()).then(data => {
                                let i = "", x = "";
                        ...
                        <div class="swiper-slide">
                            <figure class="product-image">
                                <img src="${image}"
                                     data-zoom-image="${image}"
                                     alt="${data.name}" width="800" height="900">
                            </figure>
                        </div>`;
                                    x += `
                        <div class="product-thumb swiper-slide">
                            <img src="${image}" alt="${data.name} Thumbnail" width="103"
                                 height="116">
                        </div>`
                                })
                                ...
                                setTimeout((function () {
                                    b.removeClass("load-more-overlay loading"),
                                        Wolmart.popup({
                                            items: {
                                                src: e[0].outerHTML
                                            },
                    ...
                    function () {
                        ...
                        a.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'),
                            ...
                            Wolmart.$body.on("click", ".product .btn-compare", (function (o) {
                                    ...
                                    s.hasClass("added") && returne(),
                                        ...
                                        setTimeout((function () {
                                                ...
                                                t(".page-wrapper .product img, product-wrapper .product-wrap img").each((function () {
                                                        if (this.getAttribute("src") == s.closest(".product").find("img").eq(0).attr("src")) {
                                                            var e = t(this).closest(".product").find(".btn-compare");
                                                            e.length && (e.removeClass("w-icon-compare").addClass("w-icon-check-solid"),
                                                                e.attr("href", "compare"),
                                                                e.addClass('added'))
                                                        }
                                                    }
                                    ...
                                    fetch(`/api/product/${s.closest('.product')[0].id}`).then(r => r.json()).then(data => {
                                            delete data.description, console.log(data),
                                            i.length >= 4 && q(i.shift()),
                                            i.push(data) && Wolmart.setCookie('compare', JSON.stringify(i), 4),
                                    ...
                                    a.preventDefault(),
                                        ...
                                        i.splice(0, 4), e = i.length,
                                        t(this).parent().find(".compare-product-list li").empty(),
                                        n(),
                                        Wolmart.setCookie('compare', JSON.stringify(i))
                                }
                            )),
        ...
        e.min = 1,
            ...
            e.prototype.init = function (t) {
                ...
                i.max || t.attr("max", i.max = e.max),
                    i.$value = t.val(i.value = t[0].value),
            ...
            e.prototype.startIncrease = function (t) {
                ...
                e.value < e.max && e.$value.val(++e.value),
                    itemQuantity(e.$value[0].id, e.$value[0].value),
                    console.log(this)
