    ...
    return _createClass(b, null, [{
        key: "initClass", value: function () {
            this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                ...
                headers: {
                    'X-CSRFToken': getCookies('csrftoken'), 'X-Frame': 'same-origin'
                },
                method: "post",
                withCredentials: !1,
                timeout: 3e4,
        ...
        key: "addFile", value: function (t) {
            var n = this;
            t.upload = {
                uuid: b.uuidv4(), progress: 0, total: t.size, bytesSent: 0, filename: this._renameFile(t)
                ...
                if (s[0].upload.chunked) {
                    ...
                    var i = function () {
                        ...
                        if (!(e >= r.upload.totalChunkCount)) {
                            0;
                            var t = e * u.options.chunkSize, n = Math.min(t + u.options.chunkSize, o.size), i = {
                            ...
                            r.upload.chunks[e] = {
                                file: r, index: e, dataBlock: i, status: b.UPLOADING, progress: 0, retries: 0
                            }, u._uploadData(s, [i])
                        }
                    };
                    ...
                    for (var a = [], l = 0; l < s.length; l++) a[l] = {
                        name: u._getParamName(l), data: e[l], filename: s[l].upload.filename
                    };
                    u._uploadData(s, a)
                }
            })
...
$.ajax({
    url: `/api${window.location.pathname}`, method: 'get', dataType: 'json', success: function (e) {
        $.each(e, function (i, value) {
            var removeButton = Dropzone.createElement("<button>Remove file</button>");
            let callback = null;
            let crossOrigin = "anonymous";
            let resizeThumbnail = true;
            let file = {name: `image ${i}`, size: 12345};
            myDropzone.displayExistingFile(file, value, callback, crossOrigin, resizeThumbnail);
        })
    }
})
...
myDropzone.on('addedfile', function (file) {
    var removeButton = Dropzone.createElement("<div style='font: 2rem;'><i class='bx bx-x'></i></div>");
