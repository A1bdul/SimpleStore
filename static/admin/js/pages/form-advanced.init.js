!function (s) {
    ...
    e.prototype.init = function () {
        s(".select2").select2(), s(".select2-limiting").select2({maximumSelectionLength: 2}), s(".select2-search-disable").select2({minimumResultsForSearch: 1 / 0}), s(".select2-ajax").select2({
            ajax: {
                url: "/api/brands", headers: {
                    accept: 'application/json',
                }, dataType: "json", delay: 250, data: function (e) {
                    return {q: e.term, page: e.page}
                }, processResults: function (e, t) {
                    return t.page = t.page || 1, {
                        results: e, pagination: {more: 30 * t.page < e.total_count}
                    }
                }, cache: !0
            }, placeholder: "Search for Brand", minimumInputLength: 1, templateResult: function (e) {
                if (e.loading) return e.id;
                var t = s("<div class='select2-result-repository clearfix'><div class='select2-result-repository__avatar'><img style='height: 30px; width: 30px;' src='" + e['logo'] + "' /></div><div class='select2-result-repository__meta'><div class='select2-result-repository__title'></div><div class='select2-result-repository__description'></div></div></div>");
                return t.find(".select2-result-repository__title").text(e.id), t.find(".select2-result-repository__description").text(e.description), t
        ...
        }), s("#colorpicker-default").spectrum(), s("#colorpicker-showalpha").spectrum({showAlpha: !0}), s("#colorpicker-showpaletteonly").spectrum({
            showPaletteOnly: !0,
            showPalette: !0,
            color: "#34c38f",
        ...
        }), s("#colorpicker-showintial").spectrum({showInitial: !0}), s("#colorpicker-showinput-intial").spectrum({
            showInitial: !0,
            showInput: !0
        ...
        s('[data-toggle="touchspin"]').each(function (e, t) {
            ...
            buttondown_class: "btn btn-primary",
            buttonup_class: "btn btn-primary"
        }), s("input[name='demo_vertical']").TouchSpin({verticalbuttons: !0}), s("input#defaultconfig").maxlength({
    ...
    "use strict";
    var o = $(".docs-date"), n = $(".docs-datepicker-container"), r = $(".docs-datepicker-trigger"), l = {
        show: function (e) {
    ...
    o.on({
        ...
        var t, a = e.target, i = $(a), s = i.attr("name"), c = "checkbox" === a.type ? a.checked : i.val();
        switch (s) {
            case"container":
                c ? (c = n).show() : n.hide();
                break;
        ...
        var t, a = $(this).data(), i = a.arguments || [];
...
let form = new FormData(document.getElementById('productInfo'))
